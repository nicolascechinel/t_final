...
# Training 
def train_model(criterion, num_epochs=25, num_bands=10):
    since = time.time() 
    input_num = 0
    ...
    for fold in range(10):
        ...
        with open("crossval_acc_10band.txt", 'a') as f:
...
if __name__ == "__main__":
    ...
    data_dir = '/home/nico/dev/cicatrizes_certo/spectrumNet/intel_spectrumnet-master/intel_spectrumnet-master/data'
